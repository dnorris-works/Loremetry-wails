...
INSERT INTO analysis_catalog (id, group_id, group_label, label, description, usage, needs, depends_on, uses_ai, uses_merge, ai_profile, sort_order) VALUES
  ('chapter_summaries', 'kdp-wide', 'KDP / Wide', 'Chapter Summaries', 'Real plot summary per chapter: who acts, what happens, stakes, and open loops.', 'Optional reference for you—not required by other analyses. Each chapter is summarized, then assembled into one document.', '["manuscript"]', '[]', 1, 0, 'by_chapter', 1);
INSERT INTO analysis_catalog (id, group_id, group_label, label, description, usage, needs, depends_on, uses_ai, uses_merge, ai_profile, sort_order) VALUES
