...
func TestOpenCreatesAppTables(t *testing.T) {
	...
	want := []string{
		...
		"series_bible_documents", "document_types", "analysis_catalog", "user_settings", "app_settings", "disk_hashes",
		"analysis_reports", "analysis_results", "analysis_run_stats", "chapter_descriptions",
	}
