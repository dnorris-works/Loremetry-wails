...
export namespace store {
	...
	export class StickyLineView {
	    line: number;
	    text: string;
	    highlight: boolean;
	
	    static createFrom(source: any = {}) {
	        return new StickyLineView(source);
	    }
	...
	export class StickyChapterContext {
	    chapter: string;
	    rel: string;
	    line_width: number;
	    sticky_count: number;
	    lines: StickyLineView[];
	
	    static createFrom(source: any = {}) {
	        return new StickyChapterContext(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.rel = source["rel"];
	        this.line_width = source["line_width"];
	        this.sticky_count = source["sticky_count"];
	        this.lines = this.convertValues(source["lines"], StickyLineView);
	    }
